"""
Fine-Tune Falcon on alpaca dataset
"""
import sys
import time
import argparse
...
from mindnlp.transformers import AutoModelForCausalLM, AutoConfig
from mindnlp.peft import (
    get_peft_model,
    LoraConfig,
)

from alpaca_dataset import load_examples, get_dataloader_from_ds
...
if __name__ == "__main__":
    ...
    sys.stdout = Logger("alpaca_out.log", sys.stdout)
    sys.stderr = Logger("alpaca_err.log", sys.stderr)
    ...
    parser.add_argument(
        "--save_dir",
        default=".mindnlp/peft_model/alpaca_lora",
        type=str,
